...
export const generateRefreshToken = async (req, res, next) => {
    try {
        ...
        const newRefreshToken = await signRefreshToken(isRefreshTokenValid.userId, deviceId);
...
export const getActiveRefreshTokens = async (req, res, next) => {
    try {
        ...
        const activeTokens = await refreshTokenRepository.findActiveTokensByUserId(userId);
